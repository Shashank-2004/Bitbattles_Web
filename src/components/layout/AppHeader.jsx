              ...
              <AnimatePresence>
                {isServicesOpen && (
                  <motion.div
                    ...
                    className="absolute left-1/2 top-full z-50 w-[680px] -translate-x-1/2 rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl shadow-black/10"
                  >
                    {/* Dropdown arrow */}
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {services.map((service) => (
                        <a
                          ...
                          key={service.id}
                        >
                          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-base transition group-hover:bg-bitOrange/10">
                          ...
                          <span>
                            ...
                            <span className="mt-0.5 block text-[10px] leading-tight text-slate-500 group-hover:text-bitOrange/70">
                              {service.description.slice(0, 52)}…
                            </span>
                          </span>
                        </a>
                      ))}
                    ...
                    <div className="mt-4 border-t border-slate-100 pt-3">
                      <a
                        href="/services"
                        className="text-xs font-black text-bitOrange hover:text-bitCharcoal"
                      >
                        View all services →
                      </a>
                    </div>
